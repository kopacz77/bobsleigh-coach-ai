...
import { IconRocket, IconBrain, IconActivity, IconChartLine } from "@tabler/icons-react";
...
import { DailyFeedback } from "@/lib/types/training";
...
export default function DemoPage() {
  ...
  const [aiStage, setAiStage] = useState<"analyzing" | "adapting" | "generating" | "complete">("complete");
  ...
  const handleFeedbackSubmit = async (feedback: DailyFeedback) => {
    ...
    const avgScore = (feedback.sessionRpe + feedback.muscleSoreness - feedback.energyLevel - feedback.motivationLevel) / 4;
  ...
  return (
    <ErrorBoundary>
      ...
      <Container size="lg" py="xl">
        ...
        <Card shadow="sm" padding="xl" radius="md" withBorder>
          <Stack gap="md" align="center">
            ...
            <Text size="lg" c="dimmed" ta="center" maw={600}>
              Experience the future of personalized training. Submit your daily feedback 
              and watch the AI adapt your training in real-time.
            </Text>
        ...
        >
          <Text size="sm">
            This demo uses mock data based on the Joshua Hudson Training Template analysis. 
            All adaptations are generated using rule-based AI that mimics real coaching decisions.
          </Text>
        </Alert>
            ...
            <Stack gap="md">
              {currentFeedback && (
                <Alert color="green" title="Feedback Based Adaptation">
                  <Text size="sm">
                    Training adapted based on your recent feedback (RPE: {currentFeedback.sessionRpe}/10, 
                    Soreness: {currentFeedback.muscleSoreness}/10, Energy: {currentFeedback.energyLevel}/10)
                  </Text>
                </Alert>
              )}
            ...
            <Stack gap="md">
              ...
              {currentFeedback && (
                <Card padding="md" withBorder>
                  <Stack gap="sm">
                    <Text fw={500} size="sm">Most Recent Feedback:</Text>
                    <Group>
                      ...
                      <Badge variant="light">Motivation: {currentFeedback.motivationLevel}/10</Badge>
                    </Group>
        ...
        <Card padding="md" withBorder>
          <Stack gap="sm">
            <Text fw={500} size="sm">Try These Demo Scenarios:</Text>
            <Stack gap="xs">
              <Text size="xs" c="dimmed">
