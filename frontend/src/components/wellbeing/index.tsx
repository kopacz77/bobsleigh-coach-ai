// Path: c:\users\a_kop\bobsleigh-coach-ai\frontend\src\components\wellbeing\index.tsx

// Export all wellbeing-related components
export { default as WellbeingAssessment } from './WellbeingAssessment';
export { WellbeingCalendar } from './WellbeingCalendar';
export { WellbeingTrends } from './WellbeingTrends';
