...
const MoodTracking = ({ userId }) => {
  ...
  const getMoodIcon = (score) => {
    ...
    switch (score) {
      ...
      case '2': return <IconMoodSad {...iconProps} color={theme.colors.orange[6]} />;
      case '3': return <IconMoodNeutral {...iconProps} color={theme.colors.yellow[6]} />;
      case '4': return <IconMoodSmile {...iconProps} color={theme.colors.lime[6]} />;
      case '5': return <IconMoodHappy {...iconProps} color={theme.colors.green[6]} />;
      default: return <IconMoodNeutral {...iconProps} color={theme.colors.gray[6]} />;
    }
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const moodEntry = {
        user_id: userId,
        date: dateString,
        mood_score: parseInt(currentMood.mood_score),
        energy_level: parseInt(currentMood.energy_level),
  ...
  const renderDay = (date) => {
    ...
    return (
      <Box style={{ position: 'relative' }}>
        ...
        <Box style={{ position: 'absolute', bottom: -5, left: '50%', transform: 'translateX(-50%)' }}>
  ...
  return (
    <Box>
      <Title order={2} mb="md">Mood Tracking</Title>
      <Text color="dimmed" mb="xl">
        Track your daily mood and energy levels to identify patterns and optimize your mental well-being.
      </Text>
          ...
          {moodData.length > 0 ? (
            <Box>
              ...
              <Text size="sm" color="dimmed">
                You've tracked your mood on {moodData.length} days this month. Consistent tracking helps
                identify patterns in your mental wellbeing and its impact on your performance.
              </Text>
            </Box>
          ) : (
