...
import { Card, Group, RingProgress, Text, SimpleGrid, Stack, Title, rem } from '@mantine/core';
import { IconWeight, IconClock, IconHeartbeat, IconArrowUpRight, IconArrowDownRight } from '@tabler/icons-react';
    ...
    <Card withBorder shadow="sm" p="md">
      <Stack spacing="md">
        <Group position="apart">
          ...
          <Text c="dimmed" fz="sm">Mar 9 - Mar 15, 2025</Text>
        </Group>
        ...
        <Group position="apart" pt="sm">
          <Stack spacing={0}>
            ...
            <Text size="xs" c="dimmed">85% of weekly training target reached</Text>
          </Stack>
          <RingProgress
            size={80}
            thickness={8}
