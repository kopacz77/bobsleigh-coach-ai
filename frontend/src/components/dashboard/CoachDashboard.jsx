...
const CoachDashboard = ({ userId, userProfile }) => {
          ...
          checkInsData
            .filter(checkIn => {
              ...
              const readinessScore = Math.round(
                ...
                checkIn.mental_readiness * 1.5) / 5
              );
  ...
  const getAlertIcon = (type) => {
    switch (type) {
      case 'injury': return <IconAlertTriangle size={16} color={theme.colors.red[6]} />;
      case 'readiness': return <IconBell size={16} color={theme.colors.yellow[6]} />;
      case 'missed': return <IconX size={16} color={theme.colors.orange[6]} />;
  ...
  return (
    <Box>
      ...
      <Tabs defaultValue="athletes">
        <Tabs.List mb="md">
          <Tabs.Tab value="athletes" icon={<IconUsers size={14} />}>Athletes</Tabs.Tab>
          <Tabs.Tab value="check-ins" icon={<IconClipboardCheck size={14} />}>Check-Ins</Tabs.Tab>
          <Tabs.Tab value="workouts" icon={<IconBarbell size={14} />}>Workouts</Tabs.Tab>
          <Tabs.Tab 
            value="alerts" 
            icon={<IconAlertTriangle size={14} />}
            rightSection={alerts.length > 0 ? <Badge size="xs" p={3}>{alerts.length}</Badge> : null}
          >
            Alerts
          </Tabs.Tab>
        </Tabs.List>
            ...
            <Paper p="md" radius="md" withBorder>
              <Group position="apart" mb="md">
                <Group>
                  ...
                  <Text weight={600} size="lg">Team Athletes</Text>
                </Group>
                        ...
                        <td>
                          <Menu position="bottom-end">
                            ...
                            <Menu.Dropdown>
                              ...
                              <Menu.Item icon={<IconBarbell size={14} />}>
                                Assign Workout
                              </Menu.Item>
                            </Menu.Dropdown>
                          </Menu>
              ...
              <Paper p="md" radius="md" withBorder mb="lg">
                <Group position="apart" mb="md">
                  <Group>
                    ...
                    <Text weight={600} size="lg">Alerts</Text>
                  </Group>
                    ...
                    alerts.slice(0, 5).map((alert) => (
                      <Paper key={alert.id} p="sm" withBorder radius="md" mb="sm">
                        <Group position="apart" mb="xs">
                          ...
                          <Text size="xs" color="dimmed">{formatDate(alert.date)}</Text>
                        </Group>
                        <Text size="sm" color="dimmed">{alert.details}</Text>
                      </Paper>
                    ))
                  ) : (
              ...
              <Paper p="md" radius="md" withBorder>
                <Group position="apart" mb="md">
                  <Group>
                    ...
                    <Text weight={600} size="lg">Team Performance</Text>
                  </Group>
                </Group>
                ...
                <Box>
                  <Group position="apart" mb="xs">
                    ...
                    <Group spacing={4}>
                      <Text>5.24s</Text>
                      <Badge color="green" size="sm">-0.12s</Badge>
                    </Group>
                  </Group>
                  ...
                  <Group position="apart" mb="xs">
                    ...
                    <Group spacing={4}>
                      <Text>7.8/10</Text>
                      <Badge color="green" size="sm">+0.5</Badge>
                    </Group>
                  </Group>
                  ...
                  <Group position="apart" mb="xs">
                    ...
                    <Group spacing={4}>
                      <Text>92%</Text>
                      <Badge color="green" size="sm">+4%</Badge>
                    </Group>
                  </Group>
          ...
          <Paper p="md" radius="md" withBorder>
            <Group position="apart" mb="md">
              <Group>
                ...
                <Text weight={600} size="lg">Recent Check-Ins</Text>
              </Group>
                ...
                {recentCheckIns.map((checkIn) => {
                  ...
                  return (
                    <tr key={checkIn.id}>
                      ...
                      <td>
                        <Badge 
                          color={readinessScore <= 3 ? 'red' : readinessScore <= 6 ? 'yellow' : 'green'}
                          variant="filled"
                        >
                          {readinessScore}/10
                        </Badge>
                      ...
                      <td>
                        <Badge 
                          color={checkIn.sleep_quality <= 3 ? 'red' : checkIn.sleep_quality <= 6 ? 'yellow' : 'green'}
                          variant="dot"
                        >
                      ...
                      <td>
                        <Badge 
                          color={checkIn.fatigue_level >= 7 ? 'red' : checkIn.fatigue_level >= 4 ? 'yellow' : 'green'}
                          variant="dot"
                        >
                      ...
                      <td>
                        <Badge 
                          color={checkIn.muscle_soreness >= 7 ? 'red' : checkIn.muscle_soreness >= 4 ? 'yellow' : 'green'}
                          variant="dot"
                        >
                      ...
                      <td>
                        <Badge 
                          color={checkIn.mental_readiness <= 3 ? 'red' : checkIn.mental_readiness <= 6 ? 'yellow' : 'green'}
                          variant="dot"
                        >
                      ...
                      <td>
                        {checkIn.injury_concerns ? (
                          ...
                          <Badge color="gray" variant="outline">No</Badge>
                        )}
                      </td>
                    </tr>
                  );
                  ...
                  <tr key={workout.id}>
                    <td>
                      <Group spacing="sm">
                        <Avatar 
                          ...
                          color="blue"
                        >
                          {workout.athlete_name?.split(' ').map(n => n[0]).join('')}
                        </Avatar>
                    ...
                    <td>
                      {workout.is_team_training ? (
                        ...
                        <Badge color="gray" variant="outline">Individual</Badge>
                      )}
                    </td>
                    <td>
                      <Group spacing={0}>
                        <ActionIcon color="blue" onClick={() => router.push(`/workouts/${workout.id}`)}>
                          <IconEye size={16} />
                        </ActionIcon>
          ...
          <Paper p="md" radius="md" withBorder>
            <Group position="apart" mb="md">
              <Group>
                ...
                <Text weight={600} size="lg">Athlete Alerts</Text>
              </Group>
                    ...
                    <Group position="apart" mb="xs">
                      <Group>
                        ...
                        <Box>
                          ...
                          <Text size="sm" color="dimmed">{formatDate(alert.date)}</Text>
                        </Box>
                      </Group>
                      
                      <Badge color={
                        alert.level === 'high' ? 'red' : 
                        alert.level === 'medium' ? 'yellow' : 'blue'
                      }>
