  ...
  return (
    <Box>
      ...
      <Text color="dimmed" mb="xl">
        Define your goals to help structure your training program and track your progress effectively.
      </Text>
      ...
      <Paper p="lg" radius="md" withBorder mb="xl">
        ...
        <Text weight={500} mb="xs">Development Areas</Text>
      ...
      <Paper p="lg" radius="md" withBorder mb="xl">
        <Title order={3} mb="md">Goal Timeframes</Title>
        
        <SimpleGrid cols={{ base: 1, md: 3 }} spacing="lg">
          <Box>
            <Text weight={500} mb="xs">Short-Term Goal (1-3 months)</Text>
            <Textarea
          ...
          <Box>
            <Text weight={500} mb="xs">Mid-Term Goal (3-6 months)</Text>
            <Textarea
          ...
          <Box>
            <Text weight={500} mb="xs">Long-Term Goal (6-12+ months)</Text>
            <Textarea
