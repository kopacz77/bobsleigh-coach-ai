  ...
  const handleSaveAssessment = async () => {
    ...
    try {
      ...
      const assessmentData = {
        ...
        sprint_30m: parseFloat(assessment.sprintMetrics.sprint30m) || null,
        sprint_60m: parseFloat(assessment.sprintMetrics.sprint60m) || null,
        flying_start: parseFloat(assessment.sprintMetrics.flyingStart) || null,
        bench_press_1rm: parseFloat(assessment.strengthMetrics.benchPress) || null,
        squat_1rm: parseFloat(assessment.strengthMetrics.squat) || null,
        deadlift_1rm: parseFloat(assessment.strengthMetrics.deadlift) || null,
        power_clean: parseFloat(assessment.strengthMetrics.powerClean) || null,
        pull_ups_max: parseFloat(assessment.strengthMetrics.pullUps) || null,
        vertical_jump: parseFloat(assessment.powerMetrics.verticalJump) || null,
        broad_jump: parseFloat(assessment.powerMetrics.broadJump) || null,
        medicine_ball_throw: parseFloat(assessment.powerMetrics.medicineBallThrow) || null,
        current_weight: parseFloat(assessment.bodyComposition.weight) || null,
        current_body_fat: parseFloat(assessment.bodyComposition.bodyFat) || null,
  ...
  return (
    <Box>
      ...
      <Text color="dimmed" mb="xl">
        Please provide your current performance metrics to establish a baseline for your training program.
        Fill in as many fields as you can - any unknown values can be measured during your first training session.
      </Text>
      ...
      <Paper p="lg" radius="md" withBorder mb="xl">
        ...
        <Text size="sm" color="dimmed" mb="lg">
          Sprinting ability is crucial for bobsleigh push starts. Please enter your best times if known.
        </Text>
        ...
        <Text size="sm" mb="xs">Perceived Sprint Speed</Text>
        <Text size="xs" color="dimmed" mb="xs">How would you rate your sprinting speed compared to other bobsleigh athletes?</Text>
        <Slider
      ...
      <Paper p="lg" radius="md" withBorder mb="xl">
        ...
        <Text size="sm" color="dimmed" mb="lg">
          Strength is essential for bobsleigh starts. Enter your current 1RM (one-rep max) for each lift.
        </Text>
        ...
        <Text size="sm" mb="xs">Perceived Strength Level</Text>
        <Text size="xs" color="dimmed" mb="xs">How would you rate your overall strength compared to other bobsleigh athletes?</Text>
        <Slider
      ...
      <Paper p="lg" radius="md" withBorder mb="xl">
        ...
        <Text size="sm" mb="xs">Perceived Power/Explosiveness</Text>
        <Text size="xs" color="dimmed" mb="xs">How would you rate your explosive power compared to other bobsleigh athletes?</Text>
        <Slider
      ...
      <Paper p="lg" radius="md" withBorder mb="xl">
        ...
        <Text size="sm" mb="xs">Perceived Endurance</Text>
        <Text size="xs" color="dimmed" mb="xs">How would you rate your endurance and conditioning?</Text>
        <Slider
