...
export function WorkoutList() {
  ...
  const paginatedWorkouts = filteredWorkouts.slice((page - 1) * itemsPerPage, page * itemsPerPage);
            ...
            <Table.Tbody>
              {paginatedWorkouts.map((workout) => (
                <Table.Tr key={workout.id}>
                  ...
                  <Table.Td>
                    <Badge color={getIntensityColor(workout.intensity)}>{workout.intensity}</Badge>
                  </Table.Td>
                  <Table.Td>
