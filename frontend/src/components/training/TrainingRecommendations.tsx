...
import { Button, Card, Group, Stack, Text, Title, Badge, Accordion } from '@mantine/core';
    ...
    <Card withBorder p="md" radius="md">
      <Stack>
        ...
        <Text size="sm" c="dimmed">
          These AI-generated workouts are tailored to your current fitness, fatigue levels, and competition schedule.
        </Text>
            ...
            <Accordion.Item key={index} value={workout.date}>
              <Accordion.Control>
                <Group position="apart">
                  <div>
                    ...
                    <Text size="sm">{workout.workout_type} - {workout.focus}</Text>
                  </div>
                  <Badge color={getBadgeColor(workout.intensity)}>
                    {workout.intensity}
                  </Badge>
                </Group>
              </Accordion.Control>
              ...
              <Accordion.Panel>
                <Stack spacing="xs">
                  ...
                  <Title order={5} mt="xs">Exercises</Title>
