...
import { Button, Group, Title, Text, Stack, Menu, Badge } from '@mantine/core';
import { IconPlus, IconFilter, IconCalendar, IconListDetails, IconChevronDown } from '@tabler/icons-react';
    ...
    <Group justify="space-between" wrap="nowrap">
      ...
      <Group gap="md">
        <Menu shadow="md" width={200} position="bottom-end">
          <Menu.Target>
            <Button variant="outline" leftSection={<IconFilter size={16} />} rightSection={<IconChevronDown size={14} />}>
              Filter
            </Button>
          </Menu.Target>
        ...
        <Menu shadow="md" width={200} position="bottom-end">
          <Menu.Target>
            <Button variant="outline" leftSection={<IconListDetails size={16} />} rightSection={<IconChevronDown size={14} />}>
              View
            </Button>
          </Menu.Target>
