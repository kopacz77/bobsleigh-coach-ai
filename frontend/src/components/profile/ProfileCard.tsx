...
import { Avatar, Button, Card, Group, NumberInput, Stack, Text, TextInput, Title } from '@mantine/core';
        ...
        <Stack>
          <Group position="apart">
            <Group>
              ...
              <div>
                <Title order={3}>{profileData.first_name} {profileData.last_name}</Title>
